      ...
      {visible && (
        ...
        >
          <div className="install-prompt-row">
            <img src="/pwa-512x512.png" alt="Room no: 305" className="install-prompt-icon" />

            <div className="install-prompt-text">
              <h3>Install Room no: 305</h3>
              <p>Add Room no: 305 to your device for faster access and a full-screen app experience.</p>
            </div>
          </div>
